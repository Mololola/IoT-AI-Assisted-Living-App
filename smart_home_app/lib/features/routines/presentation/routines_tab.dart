...
// Updated to use domain models and repository pattern
...
class RoutinesTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Changed: Use routineListProvider instead of mockRoutinesProvider
        ...
        data: (routines) => routines.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final routine =
                      routines[index]; // Now using Routine domain model
